...
/datum/controller/subsystem/time_track/fire()
	...
	log_perf(
		list(
			...
			SSair.processing_cost["turfs"],
			SSair.processing_cost["groups"],
			SSair.processing_cost["highpressure"],
			SSair.processing_cost["hotspots"],
			SSair.processing_cost["superconductivity"],
			SSair.processing_cost["pipenets"],
			SSair.processing_cost["rebuilds"],
